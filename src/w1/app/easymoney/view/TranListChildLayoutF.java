 ...
 */
public class TranListChildLayoutF extends LinearLayout {
    public TranListChildLayoutF(Context context) {
        super(context);
    }

    public TranListChildLayoutF(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TranListChildLayoutF(Context context, AttributeSet attrs, int defStyle) {
